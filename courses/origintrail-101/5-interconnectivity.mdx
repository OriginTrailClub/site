...
Within this lesson you will learn how the Decentralized Knowledge Graph brings Interoperability to the OriginTrail technology stack. End-to-end information is shared and secured in a fully decentralized knowledge graph network, monitored with AI and oracles. Connecting and searching vast amounts of linked data between organizations (such as in supply chains) in a verified way has not previously been possible.
