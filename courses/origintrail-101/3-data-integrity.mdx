...
OriginTrail supports many different blockchain implementations. The current version of OriginTrail utilizes Ethereum, Polygon, and Gnosis blockchains, while the fully developed solution will interface with many different blockchains.
