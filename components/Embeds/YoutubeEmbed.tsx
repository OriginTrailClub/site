...
export function YoutubeEmbed(props: YoutubeEmbedProps) {
    ...
    return (
        <div>
            ...
            <div className={Styles.aspectRatio()}>
                ...
                /> : (
                    <button {...buttonProps} className={Styles.placeholder()}>
                        <Image src={`https://img.youtube.com/vi/${videoId}/maxresdefault.jpg`} layout="fill" objectFit="contain" alt={title} />
            ...
            <span aria-hidden="true" className={Styles.label()}>{title}</span>
        </div>
    );
}
