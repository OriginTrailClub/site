...
export const contents = css({
    ...
    '&:after': {
        ...
        bottom: 0,
        content: '',
        background: 'linear-gradient(90deg, rgba(255,255,255,1) 0%, rgba(255,255,255,0) calc(0% + $$fadeSize), rgba(255,255,255,0) calc(100% - $$fadeSize), rgba(255,255,255,1) 100%)',
        pointerEvents: 'none',
    },
